...
const YieldTimeSeriesAnalysisPage = () => {
    ...
    return (
        <Box sx={{ padding: 4 }}>
            ...
            {/* Overall Chart */}
            <Typography variant="h6" gutterBottom>Overall Yield Analysis</Typography>
            ...
            {/* Cooking Chart */}
            <Typography variant="h6" gutterBottom sx={{ mt: 4 }}>Cooking Yield Analysis</Typography>
            <ResponsiveContainer width="100%" height={300}>
                <LineChart data={filteredData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                    <CartesianGrid strokeDasharray="3 3" />
                    <XAxis dataKey="date" tick={renderCustomAxisTicks} />
            ...
            {/* Storage Chart */}
            <Typography variant="h6" gutterBottom sx={{ mt: 4 }}>Storage Yield Analysis</Typography>
            <ResponsiveContainer width="100%" height={300}>
                <LineChart data={filteredData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                    <CartesianGrid strokeDasharray="3 3" />
                    <XAxis dataKey="date" tick={renderCustomAxisTicks} />
...
export default YieldTimeSeriesAnalysisPage;
